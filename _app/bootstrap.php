...
Kohana::modules(array(
	...
	'management'	=> MODPATH . APPMOD . DS . 'management',	// Management
...
// Set Cookies salt
Cookie::$salt = 'Your-Salt-Goes-Here'.date('m-y-d').md5(COMPANY_NAME);
...
/*** COMPANY > NEWS ***/
Route::set('download', '<download>(/<id1>(/<id2>(/<id3>(/<id4>))))',
		array(
				'controller' => 'home', 
				'action'     => 'download',
				'id1'	=> '[A-Za-z0-9\-\s\:\@\$\+\=\_\.\(\)]++',
