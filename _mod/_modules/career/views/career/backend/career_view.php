...
?>
	...
	<div class="form_wrapper">
        ...
        <div class="form_row">
            ...
            <div class="form_fields"><?php echo $career->start_date; ?></div>
        </div>
    
        <div class="form_row">
            <label>End Date</label>
            <div class="form_fields"><?php echo $career->end_date; ?></div>
        </div>
    ...
    <div class="form_row">
	<a class="btn btn-sm btn-primary" href="<?php echo URL::site(ADMIN.$class_name);?>/edit/<?php echo $career->id;?>">
		EDIT
	</a>
	</div>
<?php echo Form::close();?>
