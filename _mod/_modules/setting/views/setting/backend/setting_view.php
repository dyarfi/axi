...
<?php else: ?>    
<?php echo Form::open(URL::site(ADMIN.$module_name.'/edit/'.$setting->id), array(
...
?>
	...
	<a class="btn btn-sm btn-primary" href="<?php echo URL::site(ADMIN.$module_name);?>/edit/<?php echo $setting->id;?>">
		EDIT
	</a>	
<?php echo Form::close();?>
<?php endif;?>