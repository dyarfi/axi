...
<html>
   <head>
      ...
      <meta name="copyright" content="&copy; 2014 Web Architect Jakarta, Indonesia"/>
      ...
      <link rel="stylesheet" type="text/css" href="http://<?php echo $url;?>css/jquery.fancybox.css"/>
            ...
            <div class="navbar navbar-fixed-top" role="navigation">
               <div class="navbar-inner">
                  <div class="container">
                     ...
                     <a class="brand" href="http://<?php echo $url;?>"><img class="logo_a" src="http://<?php echo $url;?>images/material/logo-a.png" alt="" /><img class="logo_b" style="display: none;" src="http://<?php echo $url; ?>images/material/logo-b.png" alt=""/></a>
                     <div class="nav-collapse collapse">
                        <ul class="nav">
                           <li data-slide="2"><a href="">AXI</a></li>
                           <li data-slide="4"><a href="">Xprins</a></li>
                           <li data-slide="5"><a href="">Layan Gerak</a></li>
                           <li data-slide="6"><a href="">Layan Gerak Xpress</a></li>
                           <li data-slide="7"><a href="">News &amp; Events</a></li>
                           <li data-slide="8"><a href="">Grow With Us</a></li>
                           <li data-slide="10"><a href="">Contact</a></li>
                        </ul>
                     </div><!--/.nav-collapse -->
                  </div>
               </div>
