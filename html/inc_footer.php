<footer id="footer" class="wrapper">
   <div class="section_skew">
      <div class="img_bg">
         <img src="http://<?php echo $url; ?>images/material/section_footer.jpg" alt="" data-stellar-ratio=".005" data-stellar-horizontal-offset="10"/>
      </div>
   </div>
   <div class="foo_inside wrapper">
      ...
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_1.7.2.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_wow.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_bootstrap.min.js"></script>
      <script src="https://maps.googleapis.com/maps/api/js?v=3.exp"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_cycle.all.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_scrollReveal.js"></script>
      ...
      <!-- the popup script -->
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_fancybox.js"></script>
      ...
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_owl.carousel.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/menu/jquery_bootstrap-collapse.js"></script>
      <!-- scroll animation -->
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_wow.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_stellar.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_waypoints.min.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/scroll/jquery_easing.1.3.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_function.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_alert.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_validate.js"></script>
      <script type="text/javascript" src="http://<?php echo $url; ?>js/jquery_validate.additional.js"></script>
