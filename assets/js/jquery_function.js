jQuery(document).ready(function($) {
   ...
   //UNTUK MAP
   function initialize() {
	  var maps = document.getElementById('axiMap');
	  var mapsLatLng = maps.getAttribute('data-url');
	  //console.log(mapsLatLng);
      //var myLatlng = new google.maps.LatLng(-6.233128, 106.8653664);
	  var mapsa = mapsLatLng.split(",");
	  var myLatlng = new google.maps.LatLng(mapsa[0],mapsa[1]);
      var mapOptions = {
         zoom: 15,
         scrollwheel: false,
         center: myLatlng
