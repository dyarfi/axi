...
define('DEVELOPER_NAME','WEBARQ');
// Default Url Developer Name
define('DEVELOPER_URL','http://www.webarq.com/');
// Default Company Name
define('COMPANY_NAME','http://xprins.com'); 
// Default Site Name
...
define('DB_NAME','axi_wa2014');
define('DB_USER','axi_wausr');
define('DB_PASS','2qH))EO.*q5^');
*/
define('DB_HOST','localhost');
define('DB_NAME','wa_axi2014');
define('DB_USER','root');
define('DB_PASS','');

define('BS_PAGE',''); // Determine whether use index.php/ or not.
define('BS_URL','http://'.$_SERVER['SERVER_NAME'].'/axi/');
define('BS_ADDR',BS_URL.BS_PAGE);
define('ADMIN','admin-cp/'); // Default Administration URL
